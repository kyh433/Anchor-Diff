...
accelerate launch \
  --config_file=/home/isalab304/.cache/huggingface/accelerate/card67.yaml \
  ...
  --resume_from_checkpoint "/mnt/data/project_kyh/MultimodalityGeneration25/weight/sd-Hunan-model-controlnet_anchor_edge_nat/s1_vh/checkpoint-5000"
