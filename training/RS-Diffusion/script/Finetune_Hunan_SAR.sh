...
export METADATA="split_by_modality_Hunan/train/s1_vh.jsonl"
export OUTPUT_DIR="/mnt/data/project_kyh/MultimodalityGeneration25/weight/sd-Hunan-model/s1_vh"

accelerate launch --config_file=/home/isalab304/.cache/huggingface/accelerate/card23.yaml \
  --main_process_port 29502 --num_processes 2 --mixed_precision="fp16" --multi_gpu \
