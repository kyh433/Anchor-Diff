...
export METADATA="split_by_modality_Hunan/train/s2_nat.jsonl"
export OUTPUT_DIR="/mnt/data/project_kyh/MultimodalityGeneration25/weight/sd-Hunan-model/s2_nat"

accelerate launch --config_file=/home/isalab304/.cache/huggingface/accelerate/card67.yaml \
  --main_process_port 29504 --num_processes 2 --mixed_precision="fp16" --multi_gpu \
