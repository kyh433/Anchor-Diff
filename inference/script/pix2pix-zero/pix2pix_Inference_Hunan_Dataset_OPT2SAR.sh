...
TARGET_MODALITY=SAR
# 参数配置
JSONL_PATH="/mnt/data/project_kyh/Anchor-master/data/metadata/Diffusion/Hunan_DataSet/test/s1_vh.jsonl"
BASE_MODEL_PATH="/mnt/data/project_kyh/Anchor-master/weight/RS-Diffusion/sd-Hunan-model/s2_nat/checkpoint-5000"
BASE_MODEL_PATH_2="/mnt/data/project_kyh/Anchor-master/weight/RS-Diffusion/sd-Hunan-model/s1_vh/checkpoint-5000"
...
RESULTS_FOLDER="/mnt/data/project_kyh/Anchor-master/result/pix2pix_Hunan_Dataset_${SOURCE_MODALITY}2${TARGET_MODALITY}"
